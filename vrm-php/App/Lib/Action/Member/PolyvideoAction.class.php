...
class PolyvideoAction extends MemberAction {
    ...
    public function index() {
        ...
        foreach ($viewlist as $k => $view) {
            ...
            $hotployrow = M("Pano_ployvideo")->where($lwhere)->select();
    ...
    public function ployview() {
        ...
        if (I("post.dopost") == "save") {
            ...
            switch ($action) {
                case "add":
                    $id = M("Pano_ployvideo")->add($data);
                    $this->redirect($backurl);
                    exit();
                    break;
                case "edit":
                    $id = I("get.id");
                    M("Pano_ployvideo")->where(array("id" => $id))->save($data);
                    $this->redirect($backurl);
                    exit();
                    break;
            }
        ...
        switch ($action) {
            ...
            case "edit":
                $id = I("get.id");
                $row = M("Pano_ployvideo")->where(array("id" => $id))->find();
                if ($row["scene_id"] != "") {
            ...
            case "del":
                ...
                M("Pano_ployvideo")->where(array("id" => $id))->delete();
                $this->redirect($backurl);
                exit();
                break;
        }
    ...
    function ploysetxml() {
        ...
        $this->display('./App/Tpl/Member/Polyvideo/ployset.xml', 'utf-8', 'text/xml');
    }
