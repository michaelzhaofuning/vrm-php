...
class PanomenuWidget extends Widget{
    public function render($data) {
        ...
        $nome = array(
            ...
            '<a href="'.U("member/ui/index",array("pano_id"=>$theid)).'" class="pano_menu_bottom">UI皮肤</a>',
        ...
        $me = array(
            ...
            '<a href="'.U("member/ui/index",array("pano_id"=>$theid)).'" class="pano_menu_bottom me">UI皮肤</a>',
