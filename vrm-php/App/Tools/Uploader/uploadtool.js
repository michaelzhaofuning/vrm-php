...
function startUploadOneData(imgname){
    ...
    html += '<div class="imgbox"><img src="'+upload_root+'/App/Tools/Uploader/images/loading.gif" onload="photoin(this,60,60)" /></div>';
...
function recheak(url){
    ...
    if("mp3|wma".indexOf(result)>=0){
        return upload_root+"/App/Tools/Uploader/images/audio.jpg";
    }
    else if("flv|swf|mp4|m4v".indexOf(result)>=0){
        return upload_root+"/App/Tools/Uploader/images/video.jpg";
    }
    else if("zip".indexOf(result)>=0){
        return upload_root+"/App/Tools/Uploader/images/zip.png";
    }
    else{
